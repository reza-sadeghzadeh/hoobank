...
const Footer = () => {
  return (
    <section className="hoo-container text-white   mt-16">
      <div className="flex justify-center items-start  max-md:flex-col-reverse">
        <div className="w-full max-md:mt-12">
          <Image
            alt="logo"
            className="w-44 md:w-48 9xl:w-64"
            width={266}
            height={73}
            src={logo}
          />
          <p className="text-md mt-6 opacity-70 w-2/3 max-md:w-full">
            A new way to make the payments easy, reliable and secure.
          </p>
        </div>
        <div className="w-full flex justify-between items-start">
          <div className="flex justify-start items-start flex-col">
            <h4 className="mb-4 text-lg font-semibold">Usefull Links</h4>
          ...
          <div className="flex justify-start items-start flex-col">
            <h4 className="mb-4 text-lg font-semibold">Partner</h4>
      ...
      <div className="w-full h-0.5 opacity-20 bg-white my-4" />
      <div className="flex justify-between items-center max-md:flex-col-reverse pb-6">
        <p className="flex items-center max-md:text-sm md:text-md opacity-70">
          Copyright 2022 HooBank. All Rights Reserved.
        </p>
        <div className="flex justify-center items-center max-md:my-4">
          <svg
            className="mx-2"
            width="21"
            height="21"
